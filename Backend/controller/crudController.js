...
//     res.status(error.statusCode).json({ error: 'An error occurred while searching' });
//   }
// }
...
const getSummary = async (req, res) => {
  try {
    ...
    res.status(error.statusCode).json({ message: 'Error while fetching summaries' });
  }
};
...
const updateProfile = async (req, res) => {
  ...
  try {
    ...
    res.status(error.statusCode).json({ error: 'Error updating user data' });
  }
}
...
const getReport = async (req, res) => {
  try {
    ...
    res.status(error.statusCode).json({ message: 'Error while fetching reports', error: error.message });
  }
};
...
const bulkupload = async (req, res) => {
  try {
    ...
    console.error(error);
    res.status(error.statusCode).json({ error: 'Error saving data' });
  }
}
